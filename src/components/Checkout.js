...
function Checkout() {
    ...
    return (
        <div className='checkout w-full mb-2'>
            <div className="checkout__left bg-white">
                <div className="checkout__ad  mb-2">
                ...
                <h3 className='font-bold text-lg'>Hello, {user? user.email:"Guest"}</h3>
